                    ...
                    <tr onclick="window.location = '/pa165/gym/detail/${gymBadge.gym.id}'" style="cursor: pointer;">
                        ...
                        <td>
                            ...
                            <security:authorize access="hasRole('ADMIN')">
                                <my:extraTag href="/admin/gym/changeLeader/${gymBadge.gym.id}" class='btn btn-primary btn-block'>
                            ...
                            <c:choose>
                                <c:when test="${gymBadge.badge == null}">
                                    <c:if test="${gymBadge.gym.gymLeader.id ne userId}">
                                        <my:extraTag href="/badge/create?gymId=${gymBadge.gym.id}" class='btn btn-primary btn-block'>
                                ...
                                <c:otherwise>
                                    <my:extraTag href="/badge/detail/${gymBadge.badge.id}" class='btn btn-primary btn-block'>
                                        <span class="glyphicon glyphicon-eye-open"></span> 
                            ...
                            <c:if test="${gymBadge.gym.gymLeader.id eq userId}">
                                <my:extraTag href="/gym/changeType/${gymBadge.gym.id}" class='btn btn-primary btn-block'>
                                    <span class="glyphicon glyphicon-edit"></span> 
                                    <fmt:message key="gym.edit.leader"/>
                                </my:extraTag>
                                <my:extraTag href="/badge/challenges" class='btn btn-primary btn-block'>
                                    <span class="glyphicon glyphicon-edit"></span> 
